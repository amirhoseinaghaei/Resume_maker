...
from Backend.form1 import create_form1
from Backend.form2 import create_form2
from Backend.form3 import create_form3
import numpy as np 
from Animation.animation import toggleMenu
...
class Practice(QMainWindow , Form):
    def __init__(self):
        ...
        self.btn_page_1.clicked.connect(self.change_btn1)
        self.btn_page_2.clicked.connect(self.change_btn2)
        self.btn_page_3.clicked.connect(self.change_btn3)
        self.btn_page_4.clicked.connect(lambda: self.stackedWidget.setCurrentWidget(self.page_11))
        ...
        self.F3_NEXT_2.clicked.connect(lambda: self.stackedWidget_f1.setCurrentWidget(self.F1_p5))
        self.F3_PREVIOUS_2.clicked.connect(lambda: self.stackedWidget_f1.setCurrentWidget(self.F1_p4))
        self.F4_NEXT_2.clicked.connect(lambda: self.stackedWidget_f1.setCurrentWidget(self.F1_p3))
        self.F4_PREVIOUS_2.clicked.connect(lambda: self.stackedWidget_f1.setCurrentWidget(self.F1_p2))
        self.F5_NEXT_2.clicked.connect(lambda: self.stackedWidget_f1.setCurrentWidget(self.F1_p6))
        self.F5_PREVIOUS_2.clicked.connect(lambda: self.stackedWidget_f1.setCurrentWidget(self.F1_p3))
        ...
        self.rl1.clicked.connect(self.remove_l1)
        self.rs1.clicked.connect(self.remove_s1)
        self.ra1.clicked.connect(self.remove_a1)
        self.rw1.clicked.connect(self.remove_w1)
        self.re1.clicked.connect(self.remove_e1)
        self.rl2.clicked.connect(self.remove_l2)
        self.rs2.clicked.connect(self.remove_s2)
        self.re2.clicked.connect(self.remove_e2)
        self.rw2.clicked.connect(self.remove_w2)
        self.rl3.clicked.connect(self.remove_l3)
        self.rs3.clicked.connect(self.remove_s3)
        self.re3.clicked.connect(self.remove_e3)
        self.rw3.clicked.connect(self.remove_w3)
    

    def change_btn1(self) : 
        self.stackedWidget.setCurrentWidget(self.page_1)
        self.stackedWidget_f1.setCurrentWidget(self.F1_p2)
    ...
    def change_btn3(self) : 
        ...
        self.First_name_f3.setStyleSheet("background-color : #FFFFFF;")
        self.Last_name_F3.setStyleSheet("background-color : #FFFFFF;")
        self.Feild_name_f3.setStyleSheet("background-color : #FFFFFF;")
        self.Phone_F3.setStyleSheet("background-color : #FFFFFF;")
        self.Email_F3.setStyleSheet("background-color : #FFFFFF;")
        self.Website_F3.setStyleSheet("background-color : #FFFFFF;")
        self.pic_lineEdit_1.setStyleSheet("background-color : #FFFFFF;")
    ...
    def create_f1(self):
        ...
        Str = "your resume created at main directory"
    ...
    def create_f2(self):
        ...
        Str = "your resume created at {x}".format(x = self.pic_lineEdit.text() )
    ...
    def create_f3(self):
        ...
        Str = "your resume created at {x}".format(x = self.pic_lineEdit_1.text())
